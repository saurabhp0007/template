...
import BottomImageCarouselSidebarPanel from './input-panels/BottomImageCarouselSidebarPanel';
...
export default function ConfigurationPanel() {
  ...
  switch (type) {
    ...
    case 'Text':
      ...
      case 'BottomImageCarousel':
    return <BottomImageCarouselSidebarPanel key={selectedBlockId} data={data} setData={(data) => setBlock({ type, data })} />;
   default:
